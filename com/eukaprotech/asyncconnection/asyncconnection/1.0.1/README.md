...
# Installation (Java)
* Click [here](https://github.com/eukaprotech/AsyncConnection/blob/master/com/eukaprotech/asyncconnection/asyncconnection/1.0.1/asyncconnection-1.0.1.jar "Version 1.0.1 Jar file") to download the jar file. 
